...
- `make_virtual_knockout_figure.py` is a legacy diagnostic retained for provenance. It writes only to `figures/legacy/` and cannot overwrite the canonical Figure 5.
...
Each final figure has one canonical producer: Figure 1, `assemble_manuscript_figures.py`; Figures 2, 3, and 6, `make_reviewed_figures.py`; Figure 4, `make_figure4.py`; Figure 5, `make_virtual_knockout_figure.R`; and Supplementary Figure S1, `make_evidence_model.py`.
